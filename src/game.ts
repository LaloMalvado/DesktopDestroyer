...
let W=0,H=0,last=0,fps=0,tool='hammer';
...
ctx.stroke();
ctx.globalAlpha=1}ctx.restore()}function impactHammer(x,y){Effects.spawnHit(x,y,{dpr});
playHammer();
...
Bugs.hitAt(x,y,'hammer');}function burnAt(x,y,dt){Effects.spawnFlame(x,y,{dpr});
